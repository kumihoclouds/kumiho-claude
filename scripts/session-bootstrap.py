...
CONTEXT = (
    ...
    "session.  After the skill runs, agent.instruction metadata (user_name, "
    "agent_name, communication_tone, etc.) is already in your context.  "
    "Do NOT call kumiho_get_revision_by_tag for agent.instruction on "
    "subsequent turns — it was fetched once and does not change mid-session.\n"
    "\n"
